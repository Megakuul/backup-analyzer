...
<div transition:fade class="alert alert-warning z-50 w-10/12 grid place-self-center fixed bottom-5 text-xs sm:text-sm">
    ...
    <span>Caution: Using only cloud backups with a single provider can lead to vendor lock-in.
        If issues arise with that provider, you risk losing all backups.</span>
